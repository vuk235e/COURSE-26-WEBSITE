...
function PageThree({ onGoHome }) {
  return (
    <div className="w-full min-h-screen bg-brand-light flex flex-col items-center justify-center gap-4">
      <h1 className="text-3xl font-extrabold text-brand-blue uppercase">Upcoming Page Three</h1>
      <button onClick={onGoHome} className="px-4 py-2 bg-brand-white rounded-md font-bold text-brand-blue border border-black/10 cursor-pointer">
        Back to Home
      </button>
    </div>
  );
...
function PageFour({ onGoHome }) {
  return (
    <div className="w-full min-h-screen bg-brand-light flex flex-col items-center justify-center gap-4">
      <h1 className="text-3xl font-extrabold text-brand-blue uppercase">Upcoming Page Four</h1>
      <button onClick={onGoHome} className="px-4 py-2 bg-brand-white rounded-md font-bold text-brand-blue border border-black/10 cursor-pointer">
        Back to Home
      </button>
    </div>
