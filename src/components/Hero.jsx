    ...
    >
      ...
      >
        ...
        <p className="text-brand-dark/80 text-base md:text-lg text-center max-w-md md:max-w-3xl mb-1 mt-4 md:mt-0 px-2">
            Join us at this exciting summit where innovators, leaders, and professionals 
            come together to share anything and shape the future.
        </p>

        {/* Action Call Button */}
        <ItemButtonDark text="See Schedule" href="https://course.best.rs/PreliminarySchedule2026.pdf" variant="light" color="brand-light" />
        ...
        <div className="relative md:absolute md:top-[460px] md:right-[130px] z-10 my-2 md:my-0">
            <BadgeButton size={160} text="CHECK IT OUT - BEST BELGRADE INSTAGRAM" href="https://instagram.com/best_belgrade" />
        </div>
      </div>
    </section>
  );
